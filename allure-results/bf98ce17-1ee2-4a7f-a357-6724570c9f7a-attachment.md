...
- Name: my-info.spec.ts >> My Info - Emergency Contacts >> ESS user can add an emergency contact
- Location: tests\my-info.spec.ts:195:7
    ...
    - generic [ref=f3e97]:
      ...
      - generic [ref=f3e126]:
        ...
        - generic [ref=f3e175]:
          ...
          - generic [ref=f3e177]: No Records Found
        - table [ref=f3e180]:
          - rowgroup [ref=f3e181]:
            - row [ref=f3e182]:
        ...
        - generic [ref=f3e196]:
          ...
          - generic [ref=f3e199]:
            - heading "Attachments" [level=6] [ref=f3e200]
            - button " Add" [ref=f3e201] [cursor=pointer]:
              - generic [ref=f3e202]: 
              - text: Add
          - generic [ref=f3e203]:
            - separator [ref=f3e204]
            - generic [ref=f3e205]: No Records Found
          - table [ref=f3e208]:
            - rowgroup [ref=f3e209]:
              - row [ref=f3e210]:
                - columnheader "" [ref=f3e211]:
                  - generic [ref=f3e213] [cursor=pointer]:
                    - checkbox "" [ref=f3e214]
                    - generic [ref=f3e215]: 
                - columnheader "File Name" [ref=f3e217]
                - columnheader "Description" [ref=f3e218]
                - columnheader "Size" [ref=f3e219]
                - columnheader "Type" [ref=f3e220]
                - columnheader "Date Added" [ref=f3e221]
                - columnheader "Added By" [ref=f3e222]
                - columnheader "Actions" [ref=f3e223]
            - rowgroup
    - generic [ref=f3e224]:
